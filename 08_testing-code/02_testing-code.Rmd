...
- Fork the R package `wordle` from https://github.com/Stat585-at-ISU/worldle to your github account. 

- Copy the address (under the green button, looks something like `git@github.com:XXX/worldle.git`) where `XXX` is your github handle

- From inside Rstudio create a new R project using the link you copied
