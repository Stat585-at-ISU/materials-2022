...
In the terminal run `git remote -v` 

```{r eval=FALSE}
(base) heike-mbpro16:worldle hofmann$ git remote -v
origin  https://github.com/heike/worldle.git (fetch)
origin  https://github.com/heike/worldle.git (push)
upstream        https://github.com/Stat585-at-ISU/worldle.git (fetch)
upstream        https://github.com/Stat585-at-ISU/worldle.git (push)
```
